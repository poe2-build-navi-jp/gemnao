    ...
    <main>
      ...
      <div className="server-page">
        <section className="server-intro" aria-labelledby="server-intro-title">
          ...
          <ul>
            <li><CheckCircle2 size={19} />ゲームと募集目的で絞り込める</li>
            <li><CheckCircle2 size={19} />VC必須・任意・聞き専OKが分かる</li>
            <li><CheckCircle2 size={19} />募集継続の確認日を表示する</li>
            <li><CheckCircle2 size={19} />招待切れや不適切な掲載を通報できる</li>
          </ul>
        </section>
        ...
        <section className="server-guide" aria-labelledby="server-guide-title">
          ...
          <div className="server-guide-grid">
            <article><span>01</span><h3>遊ぶゲームを選ぶ</h3><p>同じゲームでもPC版・クロスプレイ・使用MODなどの参加条件を確認します。</p></article>
            <article><span>02</span><h3>募集目的を合わせる</h3><p>フレンド、ランク、固定パーティ、初心者募集など、自分の目的に近い募集を選びます。</p></article>
            <article><span>03</span><h3>時間とVC条件を見る</h3><p>普段遊ぶ曜日・時間帯と、VC必須・聞き専OKなどの条件を参加前に確認します。</p></article>
            <article><span>04</span><h3>ルールを読んで参加する</h3><p>年齢条件、禁止事項、退出方法を読み、個人情報を公開しすぎないように参加します。</p></article>
          </div>
        </section>

        <section className="server-safety" aria-labelledby="server-safety-title">
          ...
          <div>
            ...
            <a href="/discord-servers/guidelines">掲載ガイドラインを確認する <ArrowRight size={15} /></a>
          </div>
        </section>
